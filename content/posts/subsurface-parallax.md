...
Please make sure that when generating your TBN matrix, you're using all three components generated by your model importer of choice, not just computing the cross product of the first two. See [here](/posts/demystifying-tbn) for details.
